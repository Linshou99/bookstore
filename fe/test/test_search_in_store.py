...
class TestSearchInStore:
    ...
    def pre_run_initialization(self):
        ...
        self.book_info_list = gen_book.book_info_list
        assert ok
        bk_index1 = random.randint(0,9)
        bk_index2 = random.randint(0,9)
        bk_index3 = random.randint(0,9)
        self.input_str = self.book_info_list[bk_index1][0].title+" "+\
                            self.book_info_list[bk_index2][0].author+" "+\
                            self.book_info_list[bk_index3][0].tags  
